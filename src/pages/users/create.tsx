import { Box, Button, Flex, Heading, HStack, Divider, SimpleGrid, VStack } from "@chakra-ui/react";
...
export default function CreateUser() {
    ...
    const createUser = useMutation(async (user: CreateUserFormData) => {
        ...
        } // se a requisição der sucesso, executa essa funcao para invalidar e  atualizar a lista
    })

    const handleCreateUser: SubmitHandler<CreateUserFormData> = async (values) => {
        await createUser.mutateAsync(values)
        router.push('/users') // encaminha para a pagina de users
